...
export const OPENING_QUALITY_SEEDS_V5: OpeningQualitySeed[] = [
  {
    slug: "kings-gambit",
    eco: "C30",
    ...
    against: "1...e5",
    summary:
      "Королевский гамбит — острое начало, где белые жертвуют пешку f4 ради инициативы, открытой линии f и атаки на короля.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "1...e5",
    summary:
      "Партия четырёх коней — спокойное классическое начало, где обе стороны естественно развивают коней и борются за центр.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "1...e5",
    summary:
      "Слоновый дебют развивает слона на c4 без раннего Nf3, сохраняя гибкость и давление на f7.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "1.e4",
    summary:
      "Защита Алехина провоцирует белые пешки идти вперёд, чтобы затем атаковать их как чрезмерно растянутый центр.",
    variations: [
      {
        key: "alekhine-main",
        title: "Основная идея",
  ...
  },
  {
    ...
    against: "1.e4",
    summary:
      "Латышский гамбит — рискованное оружие после 1.e4 e5 2.Nf3 f5, где чёрные сразу атакуют центр ценой ослабления короля.",
    variations: [
      {
        key: "latvian-main",
  ...
  },
  {
    ...
    against: "1.e4",
    summary:
      "Гамбит Элефанта после 1.e4 e5 2.Nf3 d5 сразу бьёт по центру и ведёт к редкой тактической игре.",
    variations: [
      {
        key: "elephant-main",
