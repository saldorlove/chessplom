export const OPENING_QUALITY_SEEDS_V4 = [
    {
        slug: "petrov-defense",
        eco: "C43",
        ...
        side: "black",
        against: "1.e4",
        summary: "Русская партия — симметричная и надёжная защита, где чёрные сразу контратакуют пешку e4 ходом ...Nf6.",
        variations: [
            {
    ...
    },
    {
        ...
        side: "white",
        against: "1...e5",
        summary: "Шотландская партия рано вскрывает центр ходом d4 и ведёт к активной фигурной игре.",
        variations: [
            {
                key: "scotch-main",
                title: "Главная линия",
    ...
    },
    {
        ...
        side: "white",
        against: "1...e5",
        summary: "Центральный дебют быстро открывает центр ходом d4 и выводит ферзя в активную позицию.",
        variations: [
            {
                key: "center-main",
                title: "Классическая линия",
    ...
    },
    {
        ...
        side: "white",
        against: "1...e5",
        summary: "Северный гамбит жертвует одну или две пешки ради быстрого развития и открытых диагоналей для слонов.",
        variations: [
            {
                key: "danish-main",
    ...
    },
    {
        ...
        side: "black",
        against: "1.e4",
        summary: "Защита Филидора — спокойная и прочная система против 1.e4 с ранним ...d6.",
        variations: [
            {
                key: "philidor-main",
    ...
    },
    {
        ...
        side: "black",
        against: "1.e4",
        summary: "Скандинавская защита сразу оспаривает пешку e4 ходом ...d5 и быстро открывает центр.",
        variations: [
            {
    ...
    },
    {
        ...
        side: "black",
        against: "1.e4",
        summary: "Защита Пирца позволяет белым занять центр, чтобы затем атаковать его фигурами с фланга.",
        variations: [
            {
                key: "pirc-classical",
...
//# sourceMappingURL=openingQualitySeedDataV4.js.map