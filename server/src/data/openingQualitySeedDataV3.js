export const OPENING_QUALITY_SEEDS_V3 = [
    {
        ...
        side: "white",
        against: "1...Nf6",
        summary: "Каталонское начало соединяет идеи ферзевого гамбита и фианкетто слона g2. Белые получают долговременное давление на центр и ферзевый фланг.",
        variations: [
            {
                key: "catalan-closed",
    ...
    },
    {
        ...
        side: "black",
        against: "1.d4",
        summary: "Нимцо-индийская защита связывает коня c3 и борется против белого центра через давление на e4 и d4.",
        variations: [
            {
                key: "nimzo-classical",
    ...
    },
    {
        ...
        side: "white",
        against: "1...Nf6",
        summary: "Системное начало с d4, Nf3 и Bg5. Белые связывают коня f6 и получают понятную развивающую схему.",
        variations: [
            {
                key: "torre-main",
    ...
    },
    {
        ...
        side: "white",
        against: "1...Nf6",
        summary: "Атака Тромповского начинается ранним Bg5 и сразу ставит вопрос коню f6.",
        variations: [
            {
                key: "trompowsky-main",
                title: "Ранний Bg5",
    ...
    },
    {
        ...
        side: "black",
        against: "1.d4",
        summary: "Голландская защита начинается с ...f5: чёрные контролируют e4 и готовят активность на королевском фланге.",
        variations: [
            {
                key: "dutch-classic",
...
//# sourceMappingURL=openingQualitySeedDataV3.js.map