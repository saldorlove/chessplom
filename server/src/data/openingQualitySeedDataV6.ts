...
export const OPENING_QUALITY_SEEDS_V6: OpeningQualitySeed[] = [
  {
    slug: "birds-opening",
    eco: "A02",
    title: "Дебют Бёрда",
    ...
    summary:
      "Дебют Бёрда начинается ходом 1.f4. Белые контролируют e5 и часто получают структуры, похожие на Голландскую защиту с лишним темпом.",
    variations: [
      {
        key: "bird-main",
  ...
  },
  {
    ...
    against: "универсально",
    summary:
      "Дебют Гроба начинается ходом 1.g4. Это редкое и провокационное начало, которое быстро создаёт нестандартную игру.",
    variations: [
      {
        key: "grob-main",
  ...
  },
  {
    ...
    against: "универсально",
    summary:
      "Дебют Орангутана, или дебют Сокольского, начинается ходом 1.b4 и создаёт фланговое давление на ферзевом фланге.",
    variations: [
      {
        key: "orangutan-main",
        title: "Схема с Bb2",
  ...
  },
  {
    ...
    against: "1...e5",
    summary:
      "Детский мат — учебная ловушка с атакой на f7 ферзём и слоном. Важно знать не только атаку, но и способы защиты.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "1.d4",
    summary:
      "Новоиндийская защита развивает слона на b7 и давит на центр белых по большой диагонали.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "универсально",
    summary:
      "Система Колле — надёжная расстановка за белых с d4, Nf3, e3 и Bd3. Главная идея — подготовить e4 и атаку на h7.",
    variations: [
      {
        key: "colle-main",
        title: "Классическая схема",
  ...
  },
  {
    ...
    against: "1.e4",
    summary:
      "Защита Нимцовича начинается 1...Nc6. Чёрные гибко давят на центр и часто провоцируют белых на раннее продвижение пешек.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "1.e4",
    summary:
      "Защита Оуэна начинается ходом 1...b6. Чёрные развивают слона на b7 и давят на центр белых издалека.",
    variations: [
      {
        key: "owen-main",
        title: "Слон на b7",
  ...
  },
  {
    ...
    against: "1.e4",
    summary:
      "Современная защита отдаёт белым центр, чтобы атаковать его фигурами с фланга, прежде всего слоном g7.",
    variations: [
      {
        key: "modern-main",
