...
export const OPENING_QUALITY_SEEDS_V2: OpeningQualitySeed[] = [
  {
    ...
    against: "1.e4",
    summary:
      "Надёжная защита против 1.e4. Чёрные готовят ...d5, сохраняя крепкую пешечную структуру.",
    variations: [
      {
        key: "caro-classical",
  ...
  },
  {
    ...
    against: "1.e4",
    summary:
      "Французская защита строится вокруг прочного центра ...e6 и контрудара ...d5.",
    variations: [
      {
        key: "french-winnever",
  ...
  },
  {
    ...
    against: "1...e5",
    summary:
      "Испанская партия — классический открытый дебют с давлением на коня c6 и пешку e5.",
    variations: [
      {
        key: "spanish-berlin",
  ...
  },
  {
    ...
    against: "1...d5",
    summary:
      "Ферзевый гамбит предлагает пешку c4, чтобы отвлечь чёрную пешку d5 и усилить центр.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "1.d4",
    summary:
      "Славянская защита укрепляет d5 ходом ...c6 и сохраняет активного слона c8.",
    variations: [
      {
        key: "slav-main",
  ...
  },
  {
    ...
    against: "1.d4",
    summary:
      "Староиндийская защита отдаёт белым центр, чтобы затем атаковать его ходами ...e5 или ...c5.",
    variations: [
      {
  ...
  },
  {
    ...
    against: "1.d4",
    summary:
      "Защита Грюнфельда позволяет белым создать центр, который чёрные затем атакуют фигурами и пешками.",
    variations: [
      {
        key: "grunfeld-main",
        title: "Разменный вариант",
